...
struct RenderPass final {
  ...
  // a render pass (pipeline) usually can have multiple color attachments but only one depth attachment
  AttachmentDesc color[LVK_MAX_COLOR_ATTACHMENTS] = {};
  // Depth and stencil attachment's default store operation is DontCare
  // because normally we don't need the content after the pass
